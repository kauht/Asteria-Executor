...
int lua_GetEconItemRawWord(lua_State *L) {
  ...
  lua_pushinteger(L,
                  InventoryChanger::GetEconItemRawWord(itemIndex, wordIndex));
  return 1;
}
...
extern "C" __declspec(dllexport) void *CallFn(void *addr, int argCount,
                                              uint64_t *args) {
  if (!addr)
    return nullptr;
  void *ret = nullptr;
  ...
  case 0:
    ...
    break;
  case 1:
    ret = ((void *(*)(void *))addr)((void *)args[0]);
    break;
  case 2:
    ret = ((void *(*)(void *, void *))addr)((void *)args[0], (void *)args[1]);
    break;
  case 3:
    ret = ((void *(*)(void *, void *, void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2]);
    break;
  case 4:
    ret = ((void *(*)(void *, void *, void *, void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2], (void *)args[3]);
    break;
  case 5:
    ret = ((void *(*)(void *, void *, void *, void *, void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2], (void *)args[3],
        (void *)args[4]);
    break;
  case 6:
    ret = ((void *(*)(void *, void *, void *, void *, void *, void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2], (void *)args[3],
        (void *)args[4], (void *)args[5]);
    break;
  case 7:
    ret = ((
        void *(*)(void *, void *, void *, void *, void *, void *, void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2], (void *)args[3],
        (void *)args[4], (void *)args[5], (void *)args[6]);
    break;
  case 8:
    ret = ((void *(*)(void *, void *, void *, void *, void *, void *, void *,
                      void *))addr)(
        (void *)args[0], (void *)args[1], (void *)args[2], (void *)args[3],
        (void *)args[4], (void *)args[5], (void *)args[6], (void *)args[7]);
    break;
  case 9:
    ret = ((void *(*)(void *, void *, void *, void *, void *, void *, void *,
                      void *, void *))addr)(
...
bool LuaManager::Init() {
  ...
  lua_register(L, "RegisterCreateMoveCallbackCpp",
               lua_RegisterCreateMoveCallback);
  ...
  const char *overridePrint = "local old_print = print\n"
                              "print = function(...)\n"
                              "    local str = \"\"\n"
                              "    local n = select('#', ...)\n"
                              "    for i=1, n do\n"
