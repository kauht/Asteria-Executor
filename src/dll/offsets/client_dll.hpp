...
constexpr std::ptrdiff_t m_nDesiredKillPriority =
    0x9C; // PulseCursorCancelPriority_t
} // namespace CPulseCell_WaitForCursorsWithTag
// Parent: None
// Field count: 1
...
constexpr std::ptrdiff_t m_hTextureOverride =
    0x1448; // CStrongHandle<InfoForResourceTypeCTextureBase>
} // namespace C_EnvParticleGlow
// Parent: C_BaseEntity
// Field count: 0
...
constexpr std::ptrdiff_t m_vecNetworkableLoadout =
    0x40; // CUtlVector<CCSPlayerController_InventoryServices::NetworkedLoadoutSlot_t>
...
constexpr std::ptrdiff_t m_vecServerAuthoritativeWeaponSlots =
    0x88; // C_UtlVectorEmbeddedNetworkVar<ServerAuthoritativeWeaponSlot_t>
} // namespace CCSPlayerController_InventoryServices
// Parent: None
// Field count: 9
//
...
constexpr std::ptrdiff_t m_QueuedLightStyleStrings =
    0xED0; // C_NetworkUtlVectorBase<CUtlString>
constexpr std::ptrdiff_t m_LightStyleEvents =
    0xEE8; // C_NetworkUtlVectorBase<CUtlString>
constexpr std::ptrdiff_t m_LightStyleTargets =
    0xF00; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
constexpr std::ptrdiff_t m_StyleEvent = 0xF18; // CEntityIOOutput[4]
constexpr std::ptrdiff_t m_hLightCookie =
    0xF78; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_VisClusters =
    0x1178; // C_NetworkUtlVectorBase<uint16>
} // namespace C_BarnLight
// Parent: None
// Field count: 3
//
...
constexpr std::ptrdiff_t m_hPostSettings =
    0xF68; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
...
constexpr std::ptrdiff_t m_flClientHealthFadeChangeTimestamp =
    0x15FC;                                                       // GameTime_t
...
constexpr std::ptrdiff_t m_hOriginalController =
    0x1648; // CHandle<CCSPlayerController>
} // namespace C_CSPlayerPawnBase
...
constexpr std::ptrdiff_t m_OnHealthChanged =
    0x1210; // CEntityOutputTemplate<float32,float32>
...
constexpr std::ptrdiff_t m_BreakableContentsType =
    0x1270; // BreakableContentsType_t
...
constexpr std::ptrdiff_t m_hPhysicsAttacker =
    0x12C0; // CHandle<C_BasePlayerPawn>
...
constexpr std::ptrdiff_t m_bHasSimulatedSinceLastSceneObjectUpdate =
    0xFA2;                                                           // bool
...
constexpr std::ptrdiff_t m_hFogIndirectTexture =
    0x680; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_PublicOutputs =
    0x98; // CUtlVector<CPulse_PublicOutput>
constexpr std::ptrdiff_t m_InvokeBindings =
    0xB0; // CUtlVector<CPulse_InvokeBinding*>
...
constexpr std::ptrdiff_t m_DomainValues =
    0xF8; // CUtlVector<CPulse_DomainValue>
constexpr std::ptrdiff_t m_BlackboardReferences =
    0x110; // CUtlVector<CPulse_BlackboardReference>
constexpr std::ptrdiff_t m_OutputConnections =
    0x128; // CUtlVector<CPulse_OutputConnection*>
} // namespace CPulseGraphDef
// Parent: C_BaseEntity
// Field count: 2
//
...
constexpr std::ptrdiff_t m_aPlayerControllers =
    0x608; // C_NetworkUtlVectorBase<CHandle<CBasePlayerController>>
constexpr std::ptrdiff_t m_aPlayers =
    0x620; // C_NetworkUtlVectorBase<CHandle<C_BasePlayerPawn>>
...
constexpr std::ptrdiff_t m_animGraphNetworkedVars =
    0x20; // CAnimGraphNetworkedVariables
constexpr std::ptrdiff_t m_pAnimGraphInstance =
    0x14B0; // CSmartPtr<IAnimationGraphInstance>
constexpr std::ptrdiff_t m_nNextExternalGraphHandle =
    0x1510; // ExternalAnimGraphHandle_t
constexpr std::ptrdiff_t m_vecSecondarySkeletonNames =
    0x1518; // CUtlVector<CGlobalSymbol>
constexpr std::ptrdiff_t m_vecSecondarySkeletons =
    0x1530; // C_NetworkUtlVectorBase<CHandle<CBaseAnimGraph>>
...
constexpr std::ptrdiff_t m_hGraphDefinitionAG2 =
    0x1868; // CStrongHandle<InfoForResourceTypeCNmGraphDefinition>
constexpr std::ptrdiff_t m_serializedPoseRecipeAG2 =
    0x1870; // C_NetworkUtlVectorBase<uint8>
...
constexpr std::ptrdiff_t m_nServerSerializationContextIteration =
    0x1894;                                         // int32
constexpr std::ptrdiff_t m_primaryGraphId = 0x1898; // ResourceId_t
constexpr std::ptrdiff_t m_vecExternalGraphIds =
    0x18A0; // C_NetworkUtlVectorBase<ResourceId_t>
constexpr std::ptrdiff_t m_vecExternalClipIds =
    0x18B8; // C_NetworkUtlVectorBase<ResourceId_t>
constexpr std::ptrdiff_t m_sAnimGraph2Identifier = 0x18D0; // CGlobalSymbol
constexpr std::ptrdiff_t m_vecExternalGraphs =
    0x1AF8; // CUtlVector<ExternalAnimGraph_t>
constexpr std::ptrdiff_t m_nPrevAnimationAlgorithm =
...
constexpr std::ptrdiff_t m_Outflows =
    0x48; // CUtlVector<CPulse_OutflowConnection>
...
constexpr std::ptrdiff_t m_RequirementNodeIDs =
    0x50; // CUtlVector<PulseDocNodeID_t>
...
//
// Metadata:
// NetworkVarNames: m_vecCornerPairsNetworked
...
constexpr std::ptrdiff_t m_vecCornerPairsNetworked =
    0x6B8; // C_NetworkUtlVectorBase<SoundeventPathCornerPairNetworked_t>
}
// Parent: C_BaseEntity
// Field count: 3
//
...
constexpr std::ptrdiff_t m_PathNodes_Name =
    0x620; // CUtlVector<CUtlSymbolLarge>
...
constexpr std::ptrdiff_t m_iEffectIndex =
    0x650; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
constexpr std::ptrdiff_t m_PathNodes_Position =
    0x658; // C_NetworkUtlVectorBase<Vector>
constexpr std::ptrdiff_t m_PathNodes_TangentIn =
    0x670; // C_NetworkUtlVectorBase<Vector>
constexpr std::ptrdiff_t m_PathNodes_TangentOut =
    0x688; // C_NetworkUtlVectorBase<Vector>
constexpr std::ptrdiff_t m_PathNodes_Color =
    0x6A0; // C_NetworkUtlVectorBase<Vector>
constexpr std::ptrdiff_t m_PathNodes_PinEnabled =
    0x6B8; // C_NetworkUtlVectorBase<bool>
constexpr std::ptrdiff_t m_PathNodes_RadiusScale =
    0x6D0; // C_NetworkUtlVectorBase<float32>
} // namespace C_PathParticleRope
...
constexpr std::ptrdiff_t m_iExternalItemProviderRegisteredToken =
    0x4C0;                                                // int32
...
constexpr std::ptrdiff_t m_iWeaponGameplayAnimState =
    0x1948; // WeaponGameplayAnimState
...
constexpr std::ptrdiff_t m_vecCSSClasses =
    0x1068; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
} // namespace C_PointClientUIHUD
// Parent: None
// Field count: 1
//
...
constexpr std::ptrdiff_t m_Dismounts =
    0xE98; // CUtlVector<CHandle<C_InfoLadderDismount>>
...
// (CCSPlayer_ActionTrackingServices*) MNetworkVarTypeOverride
// MNetworkIncludeByName
// MNetworkVarTypeOverride
// MNetworkIncludeByName
// MNetworkVarTypeOverride
...
constexpr std::ptrdiff_t m_pBulletServices =
    0x1660; // CCSPlayer_BulletServices*
constexpr std::ptrdiff_t m_pHostageServices =
    0x1668;                                        // CCSPlayer_HostageServices*
...
constexpr std::ptrdiff_t m_pActionTrackingServices =
    0x1680; // CCSPlayer_ActionTrackingServices*
constexpr std::ptrdiff_t m_pDamageReactServices =
    0x1688; // CCSPlayer_DamageReactServices*
constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime =
    0x1690;                                                // GameTime_t
...
constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility =
    0x1888;                                                    // loadout_slot_t
...
constexpr std::ptrdiff_t m_vecBulletHitModels =
    0x24B0;                                     // CUtlVector<C_BulletHitModel*>
...
constexpr std::ptrdiff_t m_iBlockingUseActionInProgress =
    0x26FC; // CSPlayerBlockingUseAction_t
...
constexpr std::ptrdiff_t m_PredictedDamageTags =
    0x27C8; // C_UtlVectorEmbeddedNetworkVar<PredictedDamageTag_t>
...
constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTimeLast =
    0x3D78;                                                    // GameTime_t
...
namespace C_EnvSky {
constexpr std::ptrdiff_t m_hSkyMaterial =
    0xE88; // CStrongHandle<InfoForResourceTypeIMaterial2>
constexpr std::ptrdiff_t m_hSkyMaterialLightingOnly =
    0xE90; // CStrongHandle<InfoForResourceTypeIMaterial2>
...
constexpr std::ptrdiff_t m_nJustifyHorizontal =
    0x1154; // PointWorldTextJustifyHorizontal_t
constexpr std::ptrdiff_t m_nJustifyVertical =
    0x1158; // PointWorldTextJustifyVertical_t
...
constexpr std::ptrdiff_t m_iRopeMaterialModelIndex =
    0xED0; // CStrongHandle<InfoForResourceTypeIMaterial2>
...
constexpr std::ptrdiff_t m_PhysicsDelegate =
    0x1168; // C_RopeKeyframe::CPhysicsDelegate
constexpr std::ptrdiff_t m_hMaterial =
    0x1178; // CStrongHandle<InfoForResourceTypeIMaterial2>
...
constexpr std::ptrdiff_t m_bEndPointAttachmentPositionsDirty =
    0x0;                                                         // bitfield:1
...
// NetworkVarNames: m_pDestructiblePartsSystemComponent
// (CDestructiblePartsComponent*) NetworkVarNames: m_nRenderMode (RenderMode_t)
...
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed0 =
    0xB10; // HitGroup_t
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed1 =
    0xB14; // HitGroup_t
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed2 =
    0xB18; // HitGroup_t
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed3 =
    0xB1C; // HitGroup_t
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed4 =
    0xB20; // HitGroup_t
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed0_PartIndex =
    0xB24; // int32
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed1_PartIndex =
    0xB28; // int32
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed2_PartIndex =
    0xB2C; // int32
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed3_PartIndex =
    0xB30; // int32
constexpr std::ptrdiff_t m_nDestructiblePartInitialStateDestructed4_PartIndex =
    0xB34; // int32
constexpr std::ptrdiff_t m_pDestructiblePartsSystemComponent =
    0xB38; // CDestructiblePartsComponent*
...
constexpr std::ptrdiff_t m_vecRenderAttributes =
    0xB88; // C_UtlVectorEmbeddedNetworkVar<EntityRenderAttribute_t>
...
constexpr std::ptrdiff_t m_nRequiredDecalRtEncoding =
    0xD2D;                                        // DecalRtEncoding_t
constexpr std::ptrdiff_t m_vecViewOffset = 0xD58; // CNetworkViewOffsetVector
constexpr std::ptrdiff_t m_pClientAlphaProperty =
    0xE38;                                             // CClientAlphaProperty*
...
// NetworkVarNames: m_Entity_hLightProbeTexture_AmbientCube
// (HRenderTextureStrong) NetworkVarNames: m_Entity_hLightProbeTexture_SDF
// (HRenderTextureStrong) NetworkVarNames: m_Entity_hLightProbeTexture_SH2_DC
// (HRenderTextureStrong) NetworkVarNames: m_Entity_hLightProbeTexture_SH2_R
// (HRenderTextureStrong) NetworkVarNames: m_Entity_hLightProbeTexture_SH2_G
// (HRenderTextureStrong) NetworkVarNames: m_Entity_hLightProbeTexture_SH2_B
// (HRenderTextureStrong) NetworkVarNames:
// m_Entity_hLightProbeDirectLightIndicesTexture (HRenderTextureStrong)
// NetworkVarNames: m_Entity_hLightProbeDirectLightScalarsTexture
// (HRenderTextureStrong) NetworkVarNames:
// m_Entity_hLightProbeDirectLightShadowsTexture (HRenderTextureStrong)
...
constexpr std::ptrdiff_t m_Entity_hCubemapTexture =
    0x1688; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_bCustomCubemapTexture = 0x1690; // bool
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_AmbientCube =
    0x1698; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SDF =
    0x16A0; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_DC =
    0x16A8; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_R =
    0x16B0; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_G =
    0x16B8; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_B =
    0x16C0; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture =
    0x16C8; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture =
    0x16D0; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture =
    0x16D8; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_AssociatedEntities =
    0x40; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
constexpr std::ptrdiff_t m_AssociatedEntityNames =
    0x58; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
} // namespace ActiveModelConfig_t
// Parent: C_CSWeaponBaseGun
// Field count: 0
...
constexpr std::ptrdiff_t m_pAutoaimServices =
    0x13E8; // CPlayer_AutoaimServices*
constexpr std::ptrdiff_t m_pObserverServices =
    0x13F0;                                         // CPlayer_ObserverServices*
...
constexpr std::ptrdiff_t m_pFlashlightServices =
    0x1408; // CPlayer_FlashlightServices*
constexpr std::ptrdiff_t m_pCameraServices = 0x1410; // CPlayer_CameraServices*
constexpr std::ptrdiff_t m_pMovementServices =
    0x1418; // CPlayer_MovementServices*
constexpr std::ptrdiff_t m_ServerViewAngleChanges =
    0x1428; // C_UtlVectorEmbeddedNetworkVar<ViewAngleServerChange_t>
...
constexpr std::ptrdiff_t m_hController =
    0x15A0; // CHandle<CBasePlayerController>
constexpr std::ptrdiff_t m_hDefaultController =
    0x15A4; // CHandle<CBasePlayerController>
...
constexpr std::ptrdiff_t m_onGUIDChanged =
    0x628; // CEntityOutputTemplate<uint64,uint64>
...
constexpr std::ptrdiff_t m_TargetEntities =
    0x630; // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
constexpr std::ptrdiff_t m_nTargetChangeCount = 0x648; // int32
constexpr std::ptrdiff_t m_vecCSSClasses =
    0x650; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
constexpr std::ptrdiff_t m_szTargetsName = 0x668; // CUtlSymbolLarge
constexpr std::ptrdiff_t m_AdditionalTargetEntities =
    0x670; // CUtlVector<CHandle<C_BaseModelEntity>>
...
constexpr std::ptrdiff_t m_szAnimSkeleton =
    0x448; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCNmSkeleton>>
...
constexpr std::ptrdiff_t m_szTracerParticle =
    0x540; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
...
constexpr std::ptrdiff_t m_flRecoilMagnitudeVariance =
    0x6C8;                                                  // CFiringModeFloat
...
constexpr std::ptrdiff_t m_flDisallowAttackAfterReloadStartDuration =
    0x6E8;                                                         // float32
...
constexpr std::ptrdiff_t m_hOldFogController =
    0x1B0; // CHandle<C_FogController>
...
constexpr std::ptrdiff_t m_hActivePostProcessingVolume =
    0x1FC; // CHandle<C_PostProcessingVolume>
...
constexpr std::ptrdiff_t m_TimelineEvents =
    0x48; // CUtlVector<CPulseCell_Timeline::TimelineEvent_t>
constexpr std::ptrdiff_t m_bWaitForChildOutflows = 0x60; // bool
constexpr std::ptrdiff_t m_OnFinished = 0x68;            // CPulse_ResumePoint
constexpr std::ptrdiff_t m_OnCanceled = 0xB0;            // CPulse_ResumePoint
} // namespace CPulseCell_Timeline
...
constexpr std::ptrdiff_t m_clientOnlyEntityBehavior =
    0x628; // PointTemplateClientOnlyEntityBehavior_t
constexpr std::ptrdiff_t m_ownerSpawnGroupType =
    0x62C; // PointTemplateOwnerSpawnGroupType_t
constexpr std::ptrdiff_t m_createdSpawnGroupHandles =
    0x630; // CUtlVector<uint32>
constexpr std::ptrdiff_t m_SpawnedEntityHandles =
    0x648; // CUtlVector<CEntityHandle>
...
// MNetworkUserGroupProxy
// MNetworkUserGroupProxy
// NetworkVarNames: m_pInGameMoneyServices
// (CCSPlayerController_InGameMoneyServices*) NetworkVarNames:
// m_pInventoryServices (CCSPlayerController_InventoryServices*)
// NetworkVarNames: m_pActionTrackingServices
// (CCSPlayerController_ActionTrackingServices*) NetworkVarNames:
// m_pDamageServices (CCSPlayerController_DamageServices*) NetworkVarNames:
// m_iPing (uint32) NetworkVarNames: m_bHasCommunicationAbuseMute (bool)
...
// NetworkVarNames: m_hOriginalControllerOfCurrentPawn
// (CHandle<CCSPlayerController>) NetworkVarNames: m_iScore (int32)
...
constexpr std::ptrdiff_t m_pInGameMoneyServices =
    0x808; // CCSPlayerController_InGameMoneyServices*
constexpr std::ptrdiff_t m_pInventoryServices =
    0x810; // CCSPlayerController_InventoryServices*
constexpr std::ptrdiff_t m_pActionTrackingServices =
    0x818; // CCSPlayerController_ActionTrackingServices*
constexpr std::ptrdiff_t m_pDamageServices =
    0x820;                                // CCSPlayerController_DamageServices*
...
constexpr std::ptrdiff_t m_nQuestProgressReason =
    0x8A4; // QuestProgress::Reason
...
constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn =
    0x930;                                 // CHandle<CCSPlayerController>
...
constexpr std::ptrdiff_t m_Transforms =
    0x8;                                  // C_NetworkUtlVectorBase<CTransform>
...
constexpr std::ptrdiff_t m_hInfernoPointsSnapshot =
    0xED0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
constexpr std::ptrdiff_t m_hInfernoFillerPointsSnapshot =
    0xED8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
constexpr std::ptrdiff_t m_hInfernoOutlinePointsSnapshot =
    0xEE0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
constexpr std::ptrdiff_t m_hInfernoClimbingOutlinePointsSnapshot =
    0xEE8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
constexpr std::ptrdiff_t m_hInfernoDecalsSnapshot =
    0xEF0; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
...
constexpr std::ptrdiff_t m_nGoalDirection =
...
constexpr std::ptrdiff_t m_vecDamageTakenByHitGroup =
    0x48;                                 // CUtlVector<uint16>
...
constexpr std::ptrdiff_t m_animationController =
    0x550; // CBaseAnimGraphController
}
...
constexpr std::ptrdiff_t m_Outflows =
    0x0; // CUtlVector<PulseNodeDynamicOutflows_t::DynamicOutflow_t>
}
// Parent: C_BaseTrigger
// Field count: 2
//
...
constexpr std::ptrdiff_t m_nBlackboardReference =
    0x80; // PulseRuntimeBlackboardReferenceIndex_t
...
constexpr std::ptrdiff_t m_nBodyGroupChoices =
    0x270; // C_NetworkUtlVectorBase<int32>
...
constexpr std::ptrdiff_t m_Outputs =
    0x48; // CUtlVector<CPulse_OutflowConnection>
}
// Parent: C_CSWeaponBase
// Field count: 7
...
constexpr std::ptrdiff_t m_Outflows =
    0x0; // CUtlVector<OutflowWithRequirements_t>
}
// Parent: None
// Field count: 1
//
...
constexpr std::ptrdiff_t m_VoxelFrameData =
    0x1478; // C_NetworkUtlVectorBase<uint8>
...
constexpr std::ptrdiff_t m_vecSellbackPurchaseEntries =
    0x48; // C_UtlVectorEmbeddedNetworkVar<SellbackPurchaseEntry_t>
}
// Parent: C_BaseEntity
// Field count: 0
...
constexpr std::ptrdiff_t m_hPositionKeys =
    0xE90; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_hRotationKeys =
    0xE98; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_hTouchingEntities =
    0xF30; // CUtlVector<CHandle<C_BaseEntity>>
...
constexpr std::ptrdiff_t m_action =
    0x90; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_bActionReset =
    0xA8; // CAnimGraph2ParamOptionalRef<bool>
constexpr std::ptrdiff_t m_flWeaponActionSpeedScale =
    0xC0; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_weaponCategory =
    0xD8; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_weaponType =
    0xF0; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_weaponExtraInfo =
    0x108; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_flWeaponAmmo =
    0x120; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_flWeaponAmmoMax =
    0x138; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_flWeaponAmmoReserve =
    0x150; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_bWeaponIsSilenced =
    0x168; // CAnimGraph2ParamOptionalRef<bool>
constexpr std::ptrdiff_t m_flWeaponIronsightAmount =
    0x180; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_bIsUsingLegacyModel =
    0x198; // CAnimGraph2ParamOptionalRef<bool>
constexpr std::ptrdiff_t m_idleVariation =
    0x1B0; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_deployVariation =
    0x1C8; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_attackType =
    0x1E0; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_attackThrowStrength =
    0x1F8; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_flAttackVariation =
    0x210; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_inspectVariation =
    0x228; // CAnimGraph2ParamOptionalRef<float32>
constexpr std::ptrdiff_t m_inspectExtraInfo =
    0x240; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
constexpr std::ptrdiff_t m_reloadStage =
    0x258; // CAnimGraph2ParamOptionalRef<CGlobalSymbol>
} // namespace CCS2WeaponGraphController
// Parent: None
// Field count: 21
//
...
constexpr std::ptrdiff_t m_iEffectIndex =
    0x1098; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
...
constexpr std::ptrdiff_t m_hControlPointEnts =
    0x10DC;                                        // CHandle<C_BaseEntity>[64]
...
constexpr std::ptrdiff_t m_flexWeight =
    0x1170; // C_NetworkUtlVectorBase<float32>
...
constexpr std::ptrdiff_t m_PhonemeClasses =
    0x12F0; // C_BaseFlex::Emphasized_Phoneme[3]
} // namespace C_BaseFlex
// Parent: C_BaseToggle
// Field count: 0
...
constexpr std::ptrdiff_t m_Entity_hCubemapTexture =
    0x688; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_Entity_bCopyDiffuseFromDefaultCubemap =
    0x6D8;                                          // bool
...
constexpr std::ptrdiff_t m_Args =
    0xB8; // CUtlLeanVector<CPulseRuntimeMethodArg>
} // namespace CPulseCell_Inflow_Method
// Parent: C_BaseFlex
// Field count: 6
//
...
constexpr std::ptrdiff_t m_hMyWearables =
    0x1350; // C_NetworkUtlVectorBase<CHandle<C_EconWearable>>
...
constexpr std::ptrdiff_t m_nWaterWakeMode =
    0x136C; // C_BaseCombatCharacter::WaterWakeMode_t
...
constexpr std::ptrdiff_t m_hPlayerControllerDamager =
    0x38; // CHandle<CCSPlayerController>
constexpr std::ptrdiff_t m_hPlayerControllerRecipient =
    0x3C; // CHandle<CCSPlayerController>
...
constexpr std::ptrdiff_t m_hActorList =
    0x620; // C_NetworkUtlVectorBase<CHandle<C_BaseFlex>>
constexpr std::ptrdiff_t m_bWasPlaying = 0x638; // bool
constexpr std::ptrdiff_t m_QueuedEvents =
    0x648; // CUtlVector<C_SceneEntity::QueuedEvents_t>
...
constexpr std::ptrdiff_t m_vecAttachedModels =
    0x18A8; // CUtlVector<C_EconEntity::AttachedModelData_t>
} // namespace C_EconEntity
// Parent: CPlayerPawnComponent
// Field count: 0
...
constexpr std::ptrdiff_t m_hOutputEntities =
    0x630; // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
...
constexpr std::ptrdiff_t m_arrTournamentActiveCasterAccounts =
    0x990;                                                      // uint32[4]
...
constexpr std::ptrdiff_t m_hBlackboardResource =
    0x0; // CStrongHandle<InfoForResourceTypeIPulseGraphDef>
...
constexpr std::ptrdiff_t m_nExplodeEffectIndex =
    0x13C0; // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
...
constexpr std::ptrdiff_t m_nSnapshotTrajectoryEffectIndex =
    0x13F0; // ParticleIndex_t
constexpr std::ptrdiff_t m_hSnapshotTrajectoryParticleSnapshot =
    0x13F8; // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
constexpr std::ptrdiff_t m_arrTrajectoryTrailPoints =
    0x1400; // CUtlVector<Vector>
constexpr std::ptrdiff_t m_arrTrajectoryTrailPointCreationTimes =
    0x1418; // CUtlVector<float32>
constexpr std::ptrdiff_t m_flTrajectoryTrailEffectCreationTime =
    0x1430; // float32
} // namespace C_BaseCSGrenadeProjectile
// Parent: C_BaseEntity
// Field count: 16
...
constexpr std::ptrdiff_t m_hGradientFogTexture =
    0x608; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_animgraphCharacterModeString =
    0x3EF0;                                              // CGlobalSymbol
...
constexpr std::ptrdiff_t m_hBaseMaterial =
    0xEC0; // CStrongHandle<InfoForResourceTypeIMaterial2>
constexpr std::ptrdiff_t m_nHaloIndex =
    0xEC8; // CStrongHandle<InfoForResourceTypeIMaterial2>
...
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_AmbientCube =
    0x1600; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SDF =
    0x1608; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_DC =
    0x1610; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_R =
    0x1618; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_G =
    0x1620; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeTexture_SH2_B =
    0x1628; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightIndicesTexture =
    0x1630; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightScalarsTexture =
    0x1638; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_Entity_hLightProbeDirectLightShadowsTexture =
    0x1640; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_hConveyorModels =
    0xEB0; // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
...
constexpr std::ptrdiff_t m_networkAnimTiming =
    0x1588; // C_NetworkUtlVectorBase<uint8>
constexpr std::ptrdiff_t m_bBlockInspectUntilNextGraphUpdate = 0x15A0; // bool
} // namespace CCSPlayer_WeaponServices
// Parent: CBaseAnimGraph
// Field count: 2
namespace C_PhysMagnet {
constexpr std::ptrdiff_t m_aAttachedObjectsFromServer =
    0x1168; // CUtlVector<int32>
constexpr std::ptrdiff_t m_aAttachedObjects =
    0x1180; // CUtlVector<CHandle<C_BaseEntity>>
} // namespace C_PhysMagnet
...
constexpr std::ptrdiff_t m_parentPhysicsBoneIndices =
    0x11C8; // CUtlVector<int32>
constexpr std::ptrdiff_t m_worldSpaceBoneComputationOrder =
    0x11E0; // CUtlVector<int32>
} // namespace C_RagdollProp
// Parent: None
// Field count: 6
//
...
constexpr std::ptrdiff_t m_graphControllerManager =
    0xE88; // CAnimGraphControllerManager
constexpr std::ptrdiff_t m_pMainGraphController =
    0xF38; // CAnimGraphControllerBase*
...
constexpr std::ptrdiff_t m_hMyWeapons =
    0x48; // C_NetworkUtlVectorBase<CHandle<C_BasePlayerWeapon>>
...
constexpr std::ptrdiff_t m_ExpectedArgs =
    0x68; // CUtlLeanVector<CPulseRuntimeMethodArg>
...
constexpr std::ptrdiff_t m_vecPathNodes =
    0x710; // C_NetworkUtlVectorBase<CHandle<CPathNode>>
...
constexpr std::ptrdiff_t m_DependentObservableVars =
    0x48; // CUtlVector<PulseRuntimeVarIndex_t>
constexpr std::ptrdiff_t m_DependentObservableBlackboardReferences =
    0x60; // CUtlVector<PulseRuntimeBlackboardReferenceIndex_t>
} // namespace PulseObservableBoolExpression_t
// Parent: C_PointEntity
// Field count: 14
namespace CMapInfo {
...
constexpr std::ptrdiff_t m_SprayRenderHelper =
    0xF68; // CPlayerSprayDecalRenderHelper
} // namespace C_PlayerSprayDecal
// Parent: None
// Field count: 12
//
...
constexpr std::ptrdiff_t m_szBarrelSmokeParticle =
    0x2F8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
...
constexpr std::ptrdiff_t m_aShootSounds =
    0x418; // CUtlOrderedMap<WeaponSound_t,CSoundEventName>
} // namespace CBasePlayerWeaponVData
// Parent: C_CSGO_EndOfMatchLineupEndpoint
// Field count: 0
...
constexpr std::ptrdiff_t m_pOffScreenIndicator =
    0x1060;                                       // CPointOffScreenIndicatorUi*
...
constexpr std::ptrdiff_t m_vecCSSClasses =
    0x10B8; // C_NetworkUtlVectorBase<CUtlSymbolLarge>
...
constexpr std::ptrdiff_t m_hSplitOwner =
    0x6D4; // CHandle<CBasePlayerController>
constexpr std::ptrdiff_t m_hSplitScreenPlayers =
    0x6D8; // CUtlVector<CHandle<CBasePlayerController>>
...
constexpr std::ptrdiff_t m_nCompositeMaterialInputContainerSourceType =
    0x4; // CompositeMaterialInputContainerSourceType_t
constexpr std::ptrdiff_t m_strSpecificContainerMaterial =
    0x8; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIMaterial2>>
constexpr std::ptrdiff_t m_strAttrName = 0xE8; // CUtlString
constexpr std::ptrdiff_t m_strAlias = 0xF0;    // CUtlString
constexpr std::ptrdiff_t m_vecLooseVariables =
    0xF8; // CUtlVector<CompositeMaterialInputLooseVariable_t>
...
constexpr std::ptrdiff_t m_vecCompMatIncludes =
    0x0; // CUtlVector<CResourceNameTyped<CWeakHandle<InfoForResourceTypeCCompositeMaterialKit>>>
constexpr std::ptrdiff_t m_vecMatchFilters =
    0x18; // CUtlVector<CompositeMaterialMatchFilter_t>
constexpr std::ptrdiff_t m_vecCompositeInputContainers =
    0x30; // CUtlVector<CompositeMaterialInputContainer_t>
constexpr std::ptrdiff_t m_vecPropertyMutators =
...
constexpr std::ptrdiff_t m_nVariableType =
    0x40; // CompositeMaterialInputLooseVariableType_t
...
constexpr std::ptrdiff_t m_nValueSystemVar =
    0x90; // CompositeMaterialVarSystemVar_t
constexpr std::ptrdiff_t m_strResourceMaterial =
    0x98; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIMaterial2>>
constexpr std::ptrdiff_t m_strTextureContentAssetPath = 0x178; // CUtlString
constexpr std::ptrdiff_t m_strTextureRuntimeResourcePath =
    0x180; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCTextureBase>>
constexpr std::ptrdiff_t m_strTextureCompilationVtexTemplate =
    0x260; // CUtlString
constexpr std::ptrdiff_t m_nTextureType =
    0x268; // CompositeMaterialInputTextureType_t
...
constexpr std::ptrdiff_t m_FlashlightTexture =
    0x60; // CStrongHandle<InfoForResourceTypeCTextureBase>
constexpr std::ptrdiff_t m_MuzzleFlashTexture =
    0x68; // CStrongHandle<InfoForResourceTypeCTextureBase>
...
constexpr std::ptrdiff_t m_pszTeamPreviewVariant =
    0xC0; // CAnimGraphParamRef<char*>
constexpr std::ptrdiff_t m_pszTeamPreviewPosition =
    0xF0; // CAnimGraphParamRef<char*>
constexpr std::ptrdiff_t m_pszEndOfMatchCelebration =
    0x120; // CAnimGraphParamRef<char*>
constexpr std::ptrdiff_t m_nTeamPreviewRandom =
    0x150;                                         // CAnimGraphParamRef<int32>
...
constexpr std::ptrdiff_t m_ModelName =
    0x0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
...
constexpr std::ptrdiff_t m_ChildModelName =
    0x100; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
constexpr std::ptrdiff_t m_vecCompositeMaterialAssemblyProcedures =
    0x1E0; // CUtlVector<CompositeMaterialAssemblyProcedure_t>
constexpr std::ptrdiff_t m_vecCompositeMaterials =
    0x1F8; // CUtlVector<CompositeMaterial_t>
} // namespace CompositeMaterialEditorPoint_t
// Parent: None
// Field count: 0
...
constexpr std::ptrdiff_t m_flIronSightAmountGained_Interpolated =
    0x24; // float32
constexpr std::ptrdiff_t m_flIronSightAmountBiased_Interpolated =
    0x28;                                                     // float32
...
constexpr std::ptrdiff_t m_flFiringInaccuracyExtraWidthMultiplier =
    0xA4;                                       // float32
...
constexpr std::ptrdiff_t m_nMutatorCondition =
    0x0; // CompMatPropertyMutatorConditionType_t
constexpr std::ptrdiff_t m_strMutatorConditionContainerName = 0x8; // CUtlString
constexpr std::ptrdiff_t m_strMutatorConditionContainerVarName =
    0x10; // CUtlString
constexpr std::ptrdiff_t m_strMutatorConditionContainerVarValue =
    0x18;                                        // CUtlString
...
constexpr std::ptrdiff_t m_bEnabled = 0x0; // bool
constexpr std::ptrdiff_t m_nMutatorCommandType =
    0x4; // CompMatPropertyMutatorType_t
constexpr std::ptrdiff_t m_strInitWith_Container = 0x8; // CUtlString
constexpr std::ptrdiff_t m_strCopyProperty_InputContainerSrc =
    0x10; // CUtlString
constexpr std::ptrdiff_t m_strCopyProperty_InputContainerProperty =
    0x18;                                                         // CUtlString
constexpr std::ptrdiff_t m_strCopyProperty_TargetProperty = 0x20; // CUtlString
constexpr std::ptrdiff_t m_strRandomRollInputVars_SeedInputVar =
    0x28; // CUtlString
constexpr std::ptrdiff_t m_vecRandomRollInputVars_InputVarsToRoll =
    0x30; // CUtlVector<CUtlString>
constexpr std::ptrdiff_t m_strCopyMatchingKeys_InputContainerSrc =
    0x48; // CUtlString
constexpr std::ptrdiff_t m_strCopyKeysWithSuffix_InputContainerSrc =
    0x50; // CUtlString
constexpr std::ptrdiff_t m_strCopyKeysWithSuffix_FindSuffix =
    0x58; // CUtlString
constexpr std::ptrdiff_t m_strCopyKeysWithSuffix_ReplaceSuffix =
    0x60; // CUtlString
constexpr std::ptrdiff_t m_nSetValue_Value =
    0x68; // CompositeMaterialInputLooseVariable_t
constexpr std::ptrdiff_t m_strGenerateTexture_TargetParam = 0x2F0; // CUtlString
constexpr std::ptrdiff_t m_strGenerateTexture_InitialContainer =
    0x2F8;                                               // CUtlString
...
constexpr std::ptrdiff_t m_vecTexGenInstructions =
    0x318; // CUtlVector<CompMatPropertyMutator_t>
constexpr std::ptrdiff_t m_vecConditionalMutators =
    0x330; // CUtlVector<CompMatPropertyMutator_t>
...
constexpr std::ptrdiff_t m_strDrawText_InputContainerProperty =
    0x358;                                               // CUtlString
...
constexpr std::ptrdiff_t m_vecConditions =
    0x378; // CUtlVector<CompMatMutatorCondition_t>
} // namespace CompMatPropertyMutator_t
// Parent: None
// Field count: 3
//
...
constexpr std::ptrdiff_t m_Points =
    0x10; // CUtlVector<CompositeMaterialEditorPoint_t>
...
constexpr std::ptrdiff_t m_nCompositeMaterialMatchFilterType =
    0x0; // CompositeMaterialMatchFilterType_t
...
constexpr std::ptrdiff_t m_vecGeneratedTextures =
    0x80; // CUtlVector<GeneratedTextureHandle_t>
} // namespace CompositeMaterial_t
} // namespace client_dll
} // namespace schemas
} // namespace cs2_dumper