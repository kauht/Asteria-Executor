...
void RenderUI(IpcClient &ipc, LogServer &logServer, std::string &statusText,
              char *codeBuffer, size_t codeBufferSize,
  ...
  ImGui::Begin("ExecutorMain", nullptr,
  ...
  ImGui::InputTextMultiline("##code", codeBuffer, codeBufferSize,
                            ImVec2(-FLT_MIN, io.DisplaySize.y * 0.55f));
  ...
  if (rightAlign > 0)
    ImGui::Dummy(ImVec2(rightAlign, 0));
  ImGui::SameLine();
  ...
  ImGui::BeginChild("ScrollingLog", ImVec2(0, -FLT_MIN), true,
